...
-(void)iniSubviewsWithFrame:(CGRect)frame
{
    ...
    [firstImageView sd_setImageWithURL:[NSURL URLWithString:[sourceArr lastObject]] placeholderImage:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
    ...
    for (int i = 0; i < sourceArr.count; i++) {
        ...
        [imageview sd_setImageWithURL:[NSURL URLWithString:[sourceArr objectAtIndex:i]] placeholderImage:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
    ...
    [lastImageView sd_setImageWithURL:[NSURL URLWithString:[sourceArr objectAtIndex:0]] placeholderImage:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
