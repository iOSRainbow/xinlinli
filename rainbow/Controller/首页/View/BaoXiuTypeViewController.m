...
@interface BaoXiuTypeViewController ()

@end

@implementation BaoXiuTypeViewController
...
- (void)viewDidLoad {
    ...
    Api * api =[[Api alloc] init:self tag:@"findAllpropertytype"];
    [api findAllpropertytype];
}
